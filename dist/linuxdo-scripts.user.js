...
<div class="gpt-summary">${marked.marked.parse(existingObject.value)}</div>
  ...
  const _withScopeId$3 = (n) => (vue.pushScopeId("data-v-9ed7ab7b"), n = n(), vue.popScopeId(), n);
  ...
  const SyncBackup = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$g], ["__scopeId", "data-v-9ed7ab7b"]]);
  const _sfc_main$f = {
    methods: {
      lookop() {
