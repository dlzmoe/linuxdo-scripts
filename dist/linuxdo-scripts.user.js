...
.dark-theme .navigation-container.is-active{background:#333!important}
  ...
  const _withScopeId$3 = (n) => (vue.pushScopeId("data-v-a5a59dad"), n = n(), vue.popScopeId(), n);
  ...
  const MenuOtherCss = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$d], ["__scopeId", "data-v-a5a59dad"]]);
  const _sfc_main$c = {
    props: {
      value: {
        type: String,
  ...
  const _sfc_main$9 = {
    ...
    methods: {
      ...
      init() {
        ...
        $(".topic-body .cookeda").filter((index, element) => {
          var text = $(element).html();
          return self.list.some((item) => text.includes(item));
        }).parents(".topic-post").remove();
      }
  ...
  const MenuBlockKeyword = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$9], ["__scopeId", "data-v-73e8290a"]]);
  const _sfc_main$8 = {
    data() {
      return {
        tableData: []
