...
<button type="button" class="airegenerate" style="display:none">重新生成</button>
  ...
  const _withScopeId$3 = (n) => (vue.pushScopeId("data-v-0e067488"), n = n(), vue.popScopeId(), n);
  ...
  const _hoisted_4$4 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "tit" }, "2. 是否手动总结（默认自动总结）", -1));
  const _hoisted_5$4 = { class: "item" };
  const _hoisted_6$3 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "tit" }, "3. 是否关闭重新生成按钮（默认显示重新生成）", -1));
  const _hoisted_7$2 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "item" }, [
    /* @__PURE__ */ vue.createElementVNode("div", { class: "tit" }, "4. 配置信息")
  ], -1));
  const _hoisted_8$2 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("div", null, "5. AI 总结帖子 prompt:", -1));
  const _hoisted_9$2 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("div", { style: { "margin-top": "10px" } }, " 注意：baseurl 不带后缀和 '/'，不支持 http，请使用 https ", -1));
  const _hoisted_10$2 = { class: "item" };
  const _hoisted_11$1 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "tit" }, "6. 新建话题使用 AI 生成标题", -1));
  ...
  const GPTconfig = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$9], ["__scopeId", "data-v-0e067488"]]);
  const _sfc_main$8 = {
    data() {
      return {};
    },
