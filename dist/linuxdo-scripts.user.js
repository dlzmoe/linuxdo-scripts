...
${$(".d-editor-input").val()}
  ...
  function _sfc_render$A(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$w, [
      vue.createElementVNode("div", _hoisted_2$l, vue.toDisplayString($props.sort) + ". 是否显示最热帖子排行榜", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  function _sfc_render$z(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$v, [
      vue.createElementVNode("div", _hoisted_2$k, vue.toDisplayString($props.sort) + ". 显示返回顶部按钮", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  function _sfc_render$w(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$s, [
      vue.createElementVNode("div", _hoisted_2$h, vue.toDisplayString($props.sort) + ". 是否隐藏新消息小蓝点（除帖子未读小蓝点）", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  function _sfc_render$v(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$r, [
      vue.createElementVNode("div", _hoisted_2$g, vue.toDisplayString($props.sort) + ". gif 头像转静态图片（不喜花里胡哨的佬友可以开启）", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  function _sfc_render$u(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$q, [
      vue.createElementVNode("div", _hoisted_2$f, vue.toDisplayString($props.sort) + ". 是否隐藏首页 banner 区域", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  const MenuBlockKeyword = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["render", _sfc_render$p], ["__scopeId", "data-v-37466456"]]);
  const _sfc_main$o = {
    props: {
      value: {
        type: Object,
    ...
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
      ...
      vue.createElementVNode("dialog", _hoisted_3, [
        vue.createElementVNode("div", _hoisted_4, [
          _cache[53] || (_cache[53] = vue.createElementVNode("div", { class: "title" }, "linuxdo 增强插件设置", -1)),
          vue.createElementVNode("div", {
            class: "close",
        ...
        vue.createElementVNode("div", _hoisted_5, [
          vue.createElementVNode("ul", _hoisted_6, [
            vue.createElementVNode("li", _hoisted_7, [
              ...
              _cache[54] || (_cache[54] = vue.createTextVNode("通用设置"))
            ]),
            vue.createElementVNode("li", null, [
              vue.createVNode(_component_Setting2),
              _cache[55] || (_cache[55] = vue.createTextVNode("自定义"))
            ]),
            vue.createElementVNode("li", null, [
              vue.createVNode(_component_Setting3),
              _cache[56] || (_cache[56] = vue.createTextVNode("用户标签"))
            ]),
            vue.createElementVNode("li", null, [
              vue.createVNode(_component_Setting4),
              _cache[57] || (_cache[57] = vue.createTextVNode("AI 配置"))
            ]),
            vue.createElementVNode("li", null, [
