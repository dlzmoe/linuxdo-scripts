...
(function (vue) {
  ...
  const _hoisted_1$l = /* @__PURE__ */ vue.createElementVNode("svg", {
  ...
  const _hoisted_1$i = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ vue.createElementVNode("span", null, "等级", -1));
  const _hoisted_2$i = [
    _hoisted_1$i
  ];
  const _hoisted_3$e = {
