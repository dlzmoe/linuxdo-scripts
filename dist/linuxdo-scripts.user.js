...
(function (vue, pangu, marked, $$1) {
  ...
  const MenuOpenpostblank = /* @__PURE__ */ _export_sfc(_sfc_main$13, [["render", _sfc_render$13]]);
  const _sfc_main$12 = {
    props: ["modelValue", "sort"],
    emits: ["update:modelValue"],
    methods: {
  ...
  const MenuNewtopicreminder = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["render", _sfc_render$12]]);
  const _sfc_main$11 = {
    props: ["modelValue", "sort"],
    emits: ["update:modelValue"],
    methods: {
  ...
  const MenuAutoexpandreply = /* @__PURE__ */ _export_sfc(_sfc_main$11, [["render", _sfc_render$11]]);
  const _sfc_main$10 = {
    props: ["modelValue", "sort"],
    emits: ["update:modelValue"],
    methods: {
  ...
  const MenuAutoexpandreply1 = /* @__PURE__ */ _export_sfc(_sfc_main$10, [["render", _sfc_render$10]]);
  const _sfc_main$$ = {
    props: ["modelValue", "sort"],
    emits: ["update:modelValue"],
    methods: {
  ...
  const MenuShowcreatetime = /* @__PURE__ */ _export_sfc(_sfc_main$$, [["render", _sfc_render$$]]);
  const _sfc_main$_ = {
    props: ["modelValue", "sort"],
    emits: ["update:modelValue"],
    methods: {
  ...
  const MenuShowcreatetime1 = /* @__PURE__ */ _export_sfc(_sfc_main$_, [["render", _sfc_render$_]]);
  const _sfc_main$Z = {
    props: ["modelValue", "sort"],
    emits: ["update:modelValue"],
    methods: {
  ...
  const MenuShowfloors = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["render", _sfc_render$Z]]);
  const _sfc_main$Y = {
    props: ["modelValue", "sort"],
    emits: ["update:modelValue"],
    created() {
  ...
  const MenuHidetopicdetailtitle = /* @__PURE__ */ _export_sfc(_sfc_main$Y, [["render", _sfc_render$Y]]);
  const _sfc_main$X = {
    props: ["modelValue", "sort"],
    emits: ["update:modelValue"],
    methods: {
  ...
  const MenuTopicpreview = /* @__PURE__ */ _export_sfc(_sfc_main$X, [["render", _sfc_render$X]]);
  const _sfc_main$W = {
    props: ["modelValue", "sort"],
    emits: ["update:modelValue"],
    computed: {
  ...
  const MenuAutoRead = /* @__PURE__ */ _export_sfc(_sfc_main$W, [["render", _sfc_render$W], ["__scopeId", "data-v-2be3e9ac"]]);
  const _sfc_main$V = {
    props: ["modelValue", "sort"],
    emits: ["update:modelValue"]
  };
        ...
        vue.createElementVNode("div", _hoisted_5, [
          vue.createElementVNode("ul", _hoisted_6, [
            ...
            vue.createElementVNode("li", null, [
              ...
              _cache[56] || (_cache[56] = vue.createTextVNode("翻译/拼音"))
            ]),
            vue.createElementVNode("li", null, [
          ...
          vue.createElementVNode("div", _hoisted_8, [
            ...
            vue.createElementVNode("div", _hoisted_12, [
              vue.createVNode(_component_MenuLogoUrl, {
                ...
                "onUpdate:value": _cache[35] || (_cache[35] = ($event) => $data.settingData.logourl = $event)
              }, null, 8, ["value"]),
              vue.createVNode(_component_MenuCreatereply, {
                sort: 2,
                value: $data.settingData.QuickReply,
                "onUpdate:value": _cache[36] || (_cache[36] = ($event) => $data.settingData.QuickReply = $event)
              }, null, 8, ["value"]),
              vue.createVNode(_component_MenuBlockKeyword, {
                sort: 3,
                value: $data.settingData.blockkeywrod,
                "onUpdate:value": _cache[37] || (_cache[37] = ($event) => $data.settingData.blockkeywrod = $event)
              }, null, 8, ["value"]),
              vue.createVNode(_component_MenuBlockuserlist, {
                sort: 4,
                value: $data.settingData.blockList,
                "onUpdate:value": _cache[38] || (_cache[38] = ($event) => $data.settingData.blockList = $event)
              }, null, 8, ["value"]),
              vue.createVNode(_component_MenuShieldPosts, {
                sort: 5,
                value: $data.settingData.checked21,
                "onUpdate:value": _cache[39] || (_cache[39] = ($event) => $data.settingData.checked21 = $event)
              }, null, 8, ["value"]),
              vue.createVNode(_component_MenuOtherCss, {
                sort: 6,
                value: $data.settingData.othercss,
                "onUpdate:value": _cache[40] || (_cache[40] = ($event) => $data.settingData.othercss = $event)
              }, null, 8, ["value"])
            ]),
            vue.createElementVNode("div", _hoisted_13, [
              vue.createVNode(_component_UserTags, {
                value: $data.settingData.usertags,
                "onUpdate:value": _cache[41] || (_cache[41] = ($event) => $data.settingData.usertags = $event)
              }, null, 8, ["value"])
            ]),
            vue.createElementVNode("div", _hoisted_14, [
              vue.createVNode(_component_GPTconfig, {
                value: $data.settingData.gptdata,
                "onUpdate:value": _cache[42] || (_cache[42] = ($event) => $data.settingData.gptdata = $event)
              }, null, 8, ["value"])
            ]),
            vue.createElementVNode("div", _hoisted_15, [
              vue.createVNode(_component_MenuTranslate, {
                ...
                "onUpdate:modelValue": _cache[43] || (_cache[43] = ($event) => $data.settingData.checked32 = $event)
              }, null, 8, ["modelValue"]),
              vue.createVNode(_component_isTranslate, {
                sort: 1,
                modelValue: $data.settingData.checked32_1,
                "onUpdate:modelValue": _cache[44] || (_cache[44] = ($event) => $data.settingData.checked32_1 = $event)
              }, null, 8, ["modelValue"])
            ]),
