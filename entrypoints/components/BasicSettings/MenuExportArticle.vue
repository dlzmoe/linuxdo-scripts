...
export default {
  ...
  methods: {
    ...
    exportMarkdown() {
      ...
      // 获取文章标题
      let articleTitle = "";
      const titleElement = document.querySelector("#topic-title h1 a");
      ...
      // 获取文章标题作为文件名
      let fileName = "discourse_export.md";
      if (articleTitle) {
        fileName =
          articleTitle.replace(/[\\/:*?"<>|]/g, "_").replace(/\s+/g, "_") + ".md";
      }
