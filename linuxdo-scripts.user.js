...
${$(".d-editor-input").val()}
  ...
  const _withScopeId$5 = (n) => (vue.pushScopeId("data-v-ac149a76"), n = n(), vue.popScopeId(), n);
  const _hoisted_1$g = {
    class: "item",
    style: { "border": "none" }
  };
  ...
  const MenuShieldPosts = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$k], ["__scopeId", "data-v-ac149a76"]]);
  const _sfc_main$j = {
    props: {
      value: {
        type: Array,
