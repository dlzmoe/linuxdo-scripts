...
[size=${config.translateSize}]${segmentTranslate}[/size]`
  ...
  const MenuTranslate = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["render", _sfc_render$s], ["__scopeId", "data-v-d8d12b86"]]);
  const _sfc_main$r = {
    props: {
      value: {
        type: String,
