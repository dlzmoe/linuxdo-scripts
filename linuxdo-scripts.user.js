...
<div class="gpt-summary">${marked.parse(existingObject.value)}</div>
  ...
  const _withScopeId$3 = (n) => (vue.pushScopeId("data-v-a705d4a3"), n = n(), vue.popScopeId(), n);
  ...
  const GPTconfig = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$9], ["__scopeId", "data-v-a705d4a3"]]);
  const _sfc_main$8 = {
    data() {
      return {};
    },
