...
<div class="gpt-summary">${marked.marked.parse(existingObject.value)}</div>
  ...
  const _withScopeId$3 = (n) => (vue.pushScopeId("data-v-b0378f6f"), n = n(), vue.popScopeId(), n);
