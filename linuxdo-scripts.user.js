...
<button type="button" class="airegenerate" style="display:none">重新生成</button>
  ...
  const _withScopeId = (n) => (vue.pushScopeId("data-v-452b62fd"), n = n(), vue.popScopeId(), n);
  ...
  const GPTconfig = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["__scopeId", "data-v-452b62fd"]]);
  const _sfc_main$1 = {
    props: ["modelValue", "sort"],
    emits: ["update:modelValue"],
    created() {
