...
(function (vue) {
  ...
  const MenuAutoRead = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["render", _sfc_render$s], ["__scopeId", "data-v-44945bb2"]]);
  const _sfc_main$r = {
    props: ["modelValue", "sort"],
    emits: ["update:modelValue"]
  };
  ...
  function _sfc_render$r(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$n, [
      vue.createElementVNode("div", _hoisted_2$n, vue.toDisplayString($props.sort) + ". 是否开启只看楼主", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  function _sfc_render$q(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$m, [
      vue.createElementVNode("div", _hoisted_2$m, vue.toDisplayString($props.sort) + ". 智能限制楼层高度", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  function _sfc_render$o(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$l, [
      vue.createElementVNode("div", _hoisted_2$l, vue.toDisplayString($props.sort) + ". 是否开启中英文混排优化显示", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  function _sfc_render$n(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$k, [
      vue.createElementVNode("div", _hoisted_2$k, vue.toDisplayString($props.sort) + ". 是否显示等级查询按钮", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  function _sfc_render$m(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$j, [
      vue.createElementVNode("div", _hoisted_2$j, vue.toDisplayString($props.sort) + ". 消息通知仅显示未读", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  function _sfc_render$l(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$i, [
      vue.createElementVNode("div", _hoisted_2$i, vue.toDisplayString($props.sort) + ". 是否屏蔽模糊文字", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  function _sfc_render$k(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$h, [
      vue.createElementVNode("div", _hoisted_2$h, vue.toDisplayString($props.sort) + ". 只看自己签名尾巴", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  function _sfc_render$j(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$g, [
      vue.createElementVNode("div", _hoisted_2$g, vue.toDisplayString($props.sort) + ". 开启左侧快速访问", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  function _sfc_render$h(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$e, [
      vue.createElementVNode("div", _hoisted_2$e, vue.toDisplayString($props.sort) + ". 快速打开 Shared（需提前解锁 Shared）", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
...
${$(".d-editor-input").val()}
  ...
  function _sfc_render$g(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$d, [
      vue.createElementVNode("div", _hoisted_2$d, vue.toDisplayString($props.sort) + ". 编辑器切换 ja 字体", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  function _sfc_render$f(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$c, [
      vue.createElementVNode("div", _hoisted_2$c, vue.toDisplayString($props.sort) + ". 首页新增按创建时间排序", 1),
      vue.withDirectives(vue.createElementVNode("input", {
        type: "checkbox",
...
.dark-theme .navigation-container.is-active{background:#333!important}
  ...
  function _sfc_render$e(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$b, [
      vue.createElementVNode("div", _hoisted_2$b, vue.toDisplayString($props.sort) + ". 开启列表页导航栏浮动", 1),
      vue.createElementVNode("input", {
        type: "checkbox",
        checked: $props.modelValue,
        onChange: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:modelValue", $event.target.checked))
  ...
  const _withScopeId$3 = (n) => (vue.pushScopeId("data-v-0909c3ad"), n = n(), vue.popScopeId(), n);
  const _hoisted_1$a = { class: "item" };
  const _hoisted_2$a = { class: "tit" };
  const _hoisted_3$5 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("a", {
  ...
  const MenuOtherCss = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$d], ["__scopeId", "data-v-0909c3ad"]]);
  const _sfc_main$c = {
    props: {
      value: {
        type: String,
  ...
  function _sfc_render$c(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
      vue.createElementVNode("div", _hoisted_1$9, [
        vue.createElementVNode("div", _hoisted_2$9, vue.toDisplayString($props.sort) + ". 自定义论坛 logo", 1)
      ]),
      vue.withDirectives(vue.createElementVNode("input", {
        type: "text",
        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.textarea = $event),
  ...
  const MenuLogoUrl = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$c], ["__scopeId", "data-v-cb743585"]]);
  const _sfc_main$b = {
    props: {
      value: {
        type: String,
  ...
  function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
      vue.createElementVNode("div", _hoisted_1$8, [
        vue.createElementVNode("div", _hoisted_2$8, vue.toDisplayString($props.sort) + ". 自定义快捷回复（换行分隔）", 1)
      ]),
      vue.withDirectives(vue.createElementVNode("textarea", {
        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.textarea = $event),
        onInput: _cache[1] || (_cache[1] = (...args) => $options.handleChange && $options.handleChange(...args)),
  ...
  const MenuCreatereply = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$b], ["__scopeId", "data-v-e58a62ee"]]);
  const _sfc_main$a = {
    props: {
      value: {
        type: String,
  ...
  function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
      vue.createElementVNode("div", _hoisted_1$7, [
        vue.createElementVNode("div", _hoisted_2$7, vue.toDisplayString($props.sort) + ". 屏蔽指定用户（使用英文，分隔）", 1)
      ]),
      vue.withDirectives(vue.createElementVNode("textarea", {
        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.textarea = $event),
        onInput: _cache[1] || (_cache[1] = (...args) => $options.handleChange && $options.handleChange(...args)),
  ...
  const MenuBlockuserlist = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$a], ["__scopeId", "data-v-f84417d4"]]);
  const _sfc_main$9 = {
    props: {
      value: {
        type: String,
  ...
  function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
      vue.createElementVNode("div", _hoisted_1$6, [
        vue.createElementVNode("div", _hoisted_2$6, vue.toDisplayString($props.sort) + ". 关键词屏蔽功能（使用英文，分隔）屏蔽包含关键字的话题和回复 ", 1)
      ]),
      vue.withDirectives(vue.createElementVNode("textarea", {
        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.textarea = $event),
        onInput: _cache[1] || (_cache[1] = (...args) => $options.handleChange && $options.handleChange(...args))
  ...
  const MenuBlockKeyword = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$9], ["__scopeId", "data-v-c99e7560"]]);
  const _sfc_main$8 = {
    data() {
      return {
        tableData: []
      ...
      vue.createElementVNode("dialog", _hoisted_4, [
        ...
        vue.createElementVNode("div", _hoisted_17, [
          vue.createElementVNode("input", {
            ...
            style: { "display": "none" },
            accept: ".json",
            onChange: _cache[29] || (_cache[29] = (...args) => $options.handleFileUpload && $options.handleFileUpload(...args))
          }, null, 544),
          vue.createElementVNode("button", {
            class: "save",
          ...
          vue.createElementVNode("button", {
            class: "btn import",
            onClick: _cache[33] || (_cache[33] = (...args) => $options.triggerFileInput && $options.triggerFileInput(...args))
          }, "导入"),
          vue.createElementVNode("button", {
            class: "btn export",
            onClick: _cache[34] || (_cache[34] = (...args) => $options.exportData && $options.exportData(...args))
          }, "导出")
        ])
      ]),
